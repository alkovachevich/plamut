...
import { normalizeSearchQuery, hasCyrillic, hasLatin, itemMatchesQuery, searchMediaWithFallback } from "./media-search.js";
...
import { state } from "../core/state.js";
    ...
    function invalidateRelatedLibraryItemsCache(...args){
      if(!relationsCore) return;
      return relationsCore.invalidateRelatedLibraryItemsCache(...args);
    }

    function clearRelationCache(...args){
      if(!relationsCore) return;
      return relationsCore.clearRelationCache(...args);
    }

    function deferRelatedItemsRender(...args){
      if(!relationsCore) return;
      return relationsCore.deferRelatedItemsRender(...args);
    }

    function updateDetailsRelationsState(...args){
      if(!relationsCore) return;
      return relationsCore.updateDetailsRelationsState(...args);
    }

    function closeShareMenu(...args){
      if(!shareCore) return;
      return shareCore.closeShareMenu(...args);
    }

    function openCurrentPublicCardFromMenu(...args){
      if(!shareCore) return;
      return shareCore.openCurrentPublicCardFromMenu(...args);
    }

    async function copyPublicShareLinkFromMenu(...args){
      if(!shareCore) return;
      return shareCore.copyPublicShareLinkFromMenu(...args);
    }

    function toggleShareMenuQr(...args){
      if(!shareCore) return;
      return shareCore.toggleShareMenuQr(...args);
    }

    function closeShareSheet(...args){
      if(!shareCore) return;
      return shareCore.closeShareSheet(...args);
    }

    function closeShareSheetOnBackdrop(...args){
      if(!shareCore) return;
      return shareCore.closeShareSheetOnBackdrop(...args);
    }

    function toggleShareSheetQr(...args){
      if(!shareCore) return;
      return shareCore.toggleShareSheetQr(...args);
    }

    async function copyPublicShareLinkFromSheet(...args){
      if(!shareCore) return;
      return shareCore.copyPublicShareLinkFromSheet(...args);
    }

    function openCurrentPublicCardFromSheet(...args){
      if(!shareCore) return;
      return shareCore.openCurrentPublicCardFromSheet(...args);
    }

    async function shareLibrary(...args){
      if(!shareCore) return;
      return shareCore.shareLibrary(...args);
    }

    function openShareModal(...args){
      if(!shareCore) return;
      return shareCore.openShareModal(...args);
    }

    function closeShareModal(...args){
      if(!shareCore) return;
      return shareCore.closeShareModal(...args);
    }

    async function copyPublicShareLinkFromModal(...args){
      if(!shareCore) return;
      return shareCore.copyPublicShareLinkFromModal(...args);
    }

    async function copyCurrentPublicShareLink(...args){
      if(!shareCore) return;
      return shareCore.copyCurrentPublicShareLink(...args);
    }

    function toggleShareModalQr(...args){
      if(!shareCore) return;
      return shareCore.toggleShareModalQr(...args);
    }

    async function savePublicShareSettingsFromModal(...args){
      if(!shareCore) return;
      return shareCore.savePublicShareSettingsFromModal(...args);
    }

    async function savePublicShareSettings(...args){
      if(!shareCore) return;
      return shareCore.savePublicShareSettings(...args);
    }

    async function regeneratePublicShareToken(...args){
      if(!shareCore) return;
      return shareCore.regeneratePublicShareToken(...args);
    }

    async function regeneratePublicShareTokenFromModal(...args){
      if(!shareCore) return;
      return shareCore.regeneratePublicShareTokenFromModal(...args);
    }

    async function writePublicLinkToNfcFromModal(...args){
      if(!shareCore) return;
      return shareCore.writePublicLinkToNfcFromModal(...args);
    }

    async function writePublicLinkToNfc(...args){
      if(!shareCore) return;
      return shareCore.writePublicLinkToNfc(...args);
    }

    function openCurrentPublicCard(...args){
      if(!shareCore) return;
      return shareCore.openCurrentPublicCard(...args);
    }

    async function saveCurrentLibraryToCollection(...args){
      if(!publicViewCore) return;
      return publicViewCore.saveCurrentLibraryToCollection(...args);
    }

    function exitPublicShareRoute(...args){
      if(!publicViewCore) return;
      return publicViewCore.exitPublicShareRoute(...args);
    }

    async function showPublicShareScreen(...args){
      if(!publicViewCore) return;
      return publicViewCore.showPublicShareScreen(...args);
    }

    async function loadPublicShareRoute(...args){
      if(!publicViewCore) return;
      return publicViewCore.loadPublicShareRoute(...args);
    }

    function openSharedLibrary(...args){
      if(!publicViewCore) return;
      return publicViewCore.openSharedLibrary(...args);
    }

    function openPublicCategory(...args){
      if(!publicViewCore) return;
      return publicViewCore.openPublicCategory(...args);
    }

    function showPublicLibraryCategoryView(...args){
      if(!publicViewCore) return;
      return publicViewCore.showPublicLibraryCategoryView(...args);
    }

    function renderPublicPreviewGrid(...args){
      if(!publicViewCore) return;
      return publicViewCore.renderPublicPreviewGrid(...args);
    }

    function syncPublicQrButtons(...args){
      if(!publicViewCore) return;
      return publicViewCore.syncPublicQrButtons(...args);
    }

    function setPublicLibraryExpanded(...args){
      if(!publicViewCore) return;
      return publicViewCore.setPublicLibraryExpanded(...args);
    }

    function renderOwnerPanel(...args){
      if(!publicViewCore) return;
      return publicViewCore.renderOwnerPanel(...args);
    }

    function renderPublicCard(...args){
      if(!publicViewCore) return;
      return publicViewCore.renderPublicCard(...args);
    }

    function renderShareState(...args){
      if(!publicViewCore) return;
      return publicViewCore.renderShareState(...args);
    }

    function renderShareLibrary(...args){
      if(!publicViewCore) return;
      return publicViewCore.renderShareLibrary(...args);
    }
 ...
 function getSystemBrowserLanguage(){
    ...
    const statusCore = createStatusCore({
      state,
      t,
      normalizeSpaces,
      getCustomStatuses,
    ...
    function setStatusFilter(...args){
      return statusCore.setStatusFilter(...args);
    }
    ...
    function closeProfileModal(...args){
      return profileCore.closeProfileModal(...args);
    }

    function setAvatarPreview(...args){
      return profileCore.setAvatarPreview(...args);
    }

    function togglePasswordVisibility(...args){
      return profileCore.togglePasswordVisibility(...args);
    }

    async function changePassword(...args){
      return profileCore.changePassword(...args);
    }

    async function saveProfile(...args){
      return profileCore.saveProfile(...args);
    }

    async function loadProfile(...args){
      return profileCore.loadProfile(...args);
    }

    async function uploadAvatar(...args){
      return profileCore.uploadAvatar(...args);
    }

    async function removeAvatar(...args){
      return profileCore.removeAvatar(...args);
    }

    function openProfileModal(...args){
      return profileCore.openProfileModal(...args);
    }
    ...
    async function addCustomStatus(...args){
      return statusCore.addCustomStatus(...args);
    }

    function changeStatusById(...args){
      return statusCore.changeStatusById(...args);
    }

    function changeStatusFromDetails(...args){
      return statusCore.changeStatusFromDetails(...args);
    }

    async function setStatus(...args){
      return statusCore.setStatus(...args);
    }

    async function moveCurrentItemToBlacklist(...args){
      return statusCore.moveCurrentItemToBlacklist(...args);
    }
...
async function normalizeDescriptionFields(description, { translateMissing = false } = {}){
    ...
    async function renderRelatedItemsSection(...args){
      if(!relationsCore) return;
      return relationsCore.renderRelatedItemsSection(...args);
    }

    async function openRelationsScreen(...args){
      if(!relationsCore) return;
      return relationsCore.openRelationsScreen(...args);
    }

    function backToDetailsFromRelations(...args){
      if(!relationsCore) return;
      return relationsCore.backToDetailsFromRelations(...args);
    }

    async function renderRelationsScreen(...args){
      if(!relationsCore) return;
      return relationsCore.renderRelationsScreen(...args);
    }
  ...
  async function deleteItemFromSupabase(item, category = state.currentCategory){
    ...
    relationsCore = createRelationsCore({
      state,
      t,
      BASE_CATEGORIES,
      TMDB_API_KEY,
      ...
      getItemById,
      hideAllScreens,
      openCardById: (...args) => openCardById(...args),
      backToCategory,
      openCategory,
      openPublicCategory
    })

    shareCore = createShareCore({
      state,
      t,
      normalizeSpaces,
      setTextIfPresent,
    ...
    publicViewCore = createPublicViewCore({
      state,
      t,
      getCurrentUser,
      showAuthScreen,
      ...
      normalizeSpaces,
      getShareLibraryMode,
      collectPublicPreviewItems
    });

    const detailsCore = createDetailsCore({
      state,
      t,
      escapeHtml,
      getBookDisplayTitle,
      ...
      pickBestDescription,
      updateDetailsRelationsState,
      deferRelatedItemsRender,
      updatePrimaryActionVisibility,
      saveRouteState,
      hideAllScreens,
      closeCardMenu,
    ...
    async function deleteCurrentItem(...args){
      return detailsCore.deleteCurrentItem(...args);
    }

    function closeDetailsMenu(...args){
      return detailsCore.closeDetailsMenu(...args);
    }

    function toggleDetailsMenu(...args){
      return detailsCore.toggleDetailsMenu(...args);
    }

    async function openCardById(...args){
      return detailsCore.openCardById(...args);
    }
    ...
    const register = (...args) => authCore.register(...args);
    const login = (...args) => authCore.login(...args);
    const checkAuth = (...args) => authCore.checkAuth(...args);
    const logout = (...args) => authCore.logout(...args);
...
async function ensureProfileShareTokenRpc(){
  const { data, error } = await ensureProfileShareToken();
  if(error){
...
async function regenerateProfileShareTokenRpc(){
  const { data, error } = await regenerateProfileShareToken();
  if(error){
...
function openProfileFromMenu(...args){
  return profileCore.openProfileFromMenu(...args);
}
...
const foldersCore = createFoldersCore({
  state,
  t,
  normalizeSpaces,
  escapeHtml,
...
async function saveItemFolderFromModal(...args){
  return foldersCore.saveItemFolderFromModal(...args);
}

async function getFolderUsageMap(...args){
  return foldersCore.getFolderUsageMap(...args);
}

function setFolderFilter(...args){
  return foldersCore.setFolderFilter(...args);
}

async function renderFolderRail(...args){
  return foldersCore.renderFolderRail(...args);
}

async function renderFolderManagerList(...args){
  return foldersCore.renderFolderManagerList(...args);
}

function openFolderManagerSheet(...args){
  return foldersCore.openFolderManagerSheet(...args);
}

function closeFolderManagerSheet(...args){
  return foldersCore.closeFolderManagerSheet(...args);
}

function closeFolderManagerSheetOnBackdrop(...args){
  return foldersCore.closeFolderManagerSheetOnBackdrop(...args);
}

async function createFolderFromSheet(...args){
  return foldersCore.createFolderFromSheet(...args);
}

function addCustomFolder(...args){
  return foldersCore.addCustomFolder(...args);
}

async function openFolderModalById(...args){
  return foldersCore.openFolderModalById(...args);
}

function closeFolderModal(...args){
  return foldersCore.closeFolderModal(...args);
}

async function renderFolderModalOptions(...args){
  return foldersCore.renderFolderModalOptions(...args);
}

function closeFolderModalOnBackdrop(...args){
  return foldersCore.closeFolderModalOnBackdrop(...args);
}
...
export const libraryModule = {
  openLibraryScreen: publicApi.openLibraryScreen,
  handleLibrarySearchInput: publicApi.handleLibrarySearchInput,
  openCategory: publicApi.openCategory,
  backToCategory: publicApi.backToCategory,
  openCardById: publicApi.openCardById,
  toggleCategoryFilters: publicApi.toggleCategoryFilters,
};
